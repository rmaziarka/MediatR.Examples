...
module Antares {
	...
	describe('Given activity vendors view control', () =>{
		var scope: ng.IScope,
		    element: ng.IAugmentedJQuery,
		    compile: ng.ICompileService;

		var pageObjectSelectors = {
            list: 'list#activity-vendors-view',
            header: 'list#activity-vendors-view list-header',
            noItems: 'list#activity-vendors-view list-no-items',
            items: 'list#activity-vendors-view list-item',
            item: 'list#activity-vendors-view list-item#list-item-'
        };
	    ...
	    describe('is configured', () => {
            ...
            it('when no vendors then "no items" element should be visible', () => {
                ...
                // act
                element = compile('<activity-vendors-view-control contacts="contacts" config="config"></activity-vendors-view-control')(scope);
                scope.$apply();
