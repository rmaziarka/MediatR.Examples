namespace KnightFrank.Antares.Domain.AttributeConfiguration.EntityConfigurations
{
    ...
    public class OfferControlsConfiguration : ControlsConfigurationPerThreeTypes<OfferType, RequirementType, ActivityType>
    {
        ...
        private void DefineControlsForCreate()
        {
            ...
            this.AddControl(PageType.Create, ControlCode.Offer_Price, Field<CreateOfferCommand>.Create(x => x.Price).GreaterThan(0));
            this.AddControl(PageType.Create, ControlCode.Offer_PricePerWeek, Field<CreateOfferCommand>.Create(x => x.Price).GreaterThan(0));
        ...
        {
            foreach (ActivityType activityType in EnumExtensions.GetValues<ActivityType>())
            {
                this.Use(
                    ...
                    this.When(
                        OfferType.ResidentalSale,
                        RequirementType.ResidentalSale,
                        activityType,
                        PageType.Create));
                ...
                this.Use(
                    ...
                    this.When(
                        OfferType.ResidentalLetting,
                        RequirementType.ResidentalLetting,
                        activityType,
                        PageType.Create));
            }
        }
