namespace KnightFrank.Antares.Api.Services.AzureStorage
{
    ...
    public class EntityDocumentStorageProvider : IEntityDocumentStorageProvider
    {
        ...
        public EntityDocumentStorageProvider(
        ...
        public AzureUploadUrlContainer GetUploadSasUri<T>(AttachmentUrlParameters parameters, EnumType entityDocumentType) where T : BaseEntity
        {
        ...
        public AzureDownloadUrlContainer GetDownloadSasUri<T>(AttachmentDownloadUrlParameters parameters, EnumType entityDocumentType) where T : BaseEntity
        {
            this.entityValidator.EntityExists<T>(parameters.EntityReferenceId);
