namespace KnightFrank.Antares.UITests.Pages.Panels
{
    ...
    public class SelectableContactsListPage : ProjectPageBase
    {
        ...
        private readonly ElementLocator contact = new ElementLocator(Locator.XPath, "//div[@class = 'side-panel-content']//div[text() = '{0}']/../div[text() = '{1}']//ancestor::div[@class = 'card-body']");
